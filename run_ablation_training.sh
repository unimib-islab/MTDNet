...
#         --log_file "./local/ablation_studies/ADFTD2_GRU.txt" \
#         -w 32 \
#         --seed $SEED
# done
...
#         --lr 5e-4 \
#         --log_dir "./local/ADFSplit_multiscale_final/" \
#         --log_file "./local/ablation_studies/ADFTD_GRU.txt" \
#         -w 32 \
#         --seed $SEED
# done
...
#         --lr 5e-4 \
#         --log_dir "./local/ADFSplit_multiscale_final/" \
#         --log_file "./local/ablation_studies/ADSZ_GRU.txt" \
#         -w 32 \
#         --seed $SEED
# done
...
#         --lr 5e-4 \
#         --log_dir "./local/ADFSplit_multiscale_final/" \
#         --log_file "./local/ablation_studies/APAVA_GRU.txt" \
#         -w 32 \
#         --seed $SEED
# done
...
do
    python src/single_fold.py \
        ...
        --lr 5e-4 \
        --log_dir "./local/ADFSplit_multiscale_final/" \
        --log_file "./local/ablation_studies/BrainLat.txt" \
        -w 32 \
        --seed $SEED
done
